...
class BeautyFEProductVariant(BaseProductVariant):
    @property
    def link(self):
        return f"{self.raw_link}"


class BeautyFEProductPage(BaseProductPage):
    @property
    def link(self):
        return f"{PRODUCT_LIST_FE}?p={self.id}"


class BeautyFEProduct(BaseProduct):
    def __init__(
        self,
        source: str,
        product_id: str,
...
class BeautyFEScraper(BaseScraper):
    def __init__(
        self,
        run_id: str,
        ...
        self._all_loaded_products: set[BeautyFEProduct] = set()
        self._name = "beauty_fe"

    def get_variant_price(self, product: BeautyFEProduct) -> float:
    ...
    def get_variant_volume(self, product: BeautyFEProduct) -> str:
        self.get(product.link)
    ...
    def get_variant_volume_unit(self, product: BeautyFEProduct) -> str:
        self.get(product.link)
    ...
    def get_variant_in_stock(self, product: BeautyFEProduct) -> int:
    ...
    def _load_product_variant(self, product: BeautyFEProduct):
    ...
    def load_all_product(self):
        self.load_all_product_by_url(PRODUCT_LIST_FE)
